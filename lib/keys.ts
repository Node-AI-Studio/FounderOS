...
export const KEY_SLOTS: KeySlot[] = [
  ...
  { envVar: 'SHOPIFY_STORE_DOMAIN', label: 'Shopify store domain', group: 'Shopify', hint: 'your-store.myshopify.com' },
  { envVar: 'SHOPIFY_ADMIN_TOKEN', label: 'Shopify admin token', group: 'Shopify' },
  { envVar: 'KLAVIYO_API_KEY', label: 'Klaviyo API key', group: 'Klaviyo' },
  { envVar: 'META_ADS_ACCESS_TOKEN', label: 'Meta Ads access token', group: 'Ads' },
  { envVar: 'TIKTOK_ADS_ACCESS_TOKEN', label: 'TikTok Ads access token', group: 'Ads' },
  { envVar: 'GOOGLE_ADS_DEVELOPER_TOKEN', label: 'Google Ads developer token', group: 'Ads' },
  { envVar: 'AMAZON_SP_API_REFRESH_TOKEN', label: 'Amazon SP-API refresh token', group: 'Amazon' },
