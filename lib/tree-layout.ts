...
/**
 * The wheel you turn INTO (2026-07-12): while a pillar is focused the
 ...
 * the design asked for: from left and right, not from below.
 */
...
/**
 * The visible top of the wheel (2026-07-12): pillars ride the RIM of
