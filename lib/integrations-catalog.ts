...
export const INTEGRATIONS: Integration[] = [
  ...
  { slug: 'manychat', name: 'ManyChat', tagline: 'IG DM automation', category: 'Communication', envKeys: ['MANYCHAT_API_KEY'] },
  ...
  { slug: 'beehiiv', name: 'beehiiv', tagline: 'Newsletter & subscribers', category: 'Marketing', envKeys: ['BEEHIIV_API_KEY'] },
  ...
  { slug: 'zernio', name: 'Zernio', tagline: 'Cross-platform posting', category: 'Marketing', envKeys: ['ZERNIO_API_KEY'] },
  { slug: 'webinarjam', name: 'WebinarJam', tagline: 'Webinar registrants', category: 'Marketing', envKeys: ['WEBINARJAM_API_KEY'] },
  ...
  { slug: 'miro', name: 'Miro', tagline: 'Whiteboards & maps', category: 'Creative', envKeys: ['MIRO_ACCESS_TOKEN'] },
  ...
  { slug: 'arcads', name: 'Arcads', tagline: 'AI video ads', category: 'Creative', envKeys: ['ARCADS_BASIC_AUTH'] },
];
