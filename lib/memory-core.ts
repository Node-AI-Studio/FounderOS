...
// Open-graph density. Deliberately LOW: smoothness beats richness (design note:
...
export function distillMemoryGraph(
  ...
  // centerFolder quota: the spotlighted folder (design note: "populate Claude
...
// at (R_CORE + 10) / R_CORE ≈ 1.19 units), design note: notes very close to the
 ...
 */
// the resting/tree frame breathes out a touch beyond the canvas (design note,
