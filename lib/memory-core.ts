 ...
 * Node AI rendered as the constellation of its actual brain-store notes.
 *
...
// Open-graph density. Deliberately LOW: smoothness beats richness (Node AI:
...
export function distillMemoryGraph(
  ...
  // centerFolder quota: the spotlighted folder (Node AI: "populate Claude
...
// at (R_CORE + 10) / R_CORE ≈ 1.19 units) - Node AI: notes very close to the
...
export type CameraState = {
  ...
  focusedTeam: boolean;
  /** the Node AI memory core is expanded */
 ...
 */
// the resting/tree frame breathes out a touch beyond the canvas (Node AI,
