/**
 * Node AI's three income sources - the venture lens over the OS.
 *
...
export type Venture = {
  ...
  brainTag: string;
  /** Current executive priorities - edit freely, this is Node AI's list. */
  focus: string[];
...
/** Agents on one life area for one venture (the click-through Node AI described). */
