...
export const AGENT_BRAIN_SCOPES: Record<string, string[]> = {
  ...
  'growth-planner': ['projects', 'ideas'],
  'competitor-researcher': ['sources', 'ideas'],
  'creative-strategist': ['ideas', 'writing'],
  'ad-copywriter': ['writing', 'ideas'],
  'visual-designer': ['media'],
  'format-checker': ['sources'],
  'compliance-auditor': ['sources', 'concepts'],
  'translator': ['writing'],
  'campaign-launcher': ['projects'],
  'meta-ads-auditor': ['sources'],
  'tiktok-ads-auditor': ['sources'],
  'google-ads-auditor': ['sources'],
  'budget-auditor': ['projects'],
  'experiment-designer': ['ideas', 'projects'],
  'tracking-auditor': ['sources'],
  'landing-page-auditor': ['sources'],
  'ads-reporter': ['projects'],
  // Content (dept-content)
  'content-planner': ['projects', 'ideas'],
  'creator-watcher': ['sources', 'ideas'],
  'video-analyst': ['sources'],
  'comment-reader': ['inbox', 'ideas'],
  'hook-miner': ['ideas', 'writing'],
  'script-writer': ['writing'],
  'video-producer': ['media'],
  'edit-assistant': ['media'],
  'publisher': ['media', 'projects'],
  'creator-recruiter': ['people'],
  'creator-briefer': ['writing', 'people'],
  'twenty-one-nights-producer': ['media', 'projects'],
  'performance-reader': ['sources'],
  // Retention (dept-clients)
  'lifecycle-planner': ['projects'],
  'segment-builder': ['people'],
  'email-writer': ['writing'],
  'sms-writer': ['writing'],
  'campaign-composer': ['projects', 'writing'],
  'twenty-one-nights-coach': ['people', 'writing'],
  'offer-designer': ['ideas'],
  'referral-runner': ['people'],
  'win-back-writer': ['writing'],
  'flow-auditor': ['sources'],
  'retention-reporter': ['projects'],
  // Store (dept-sales)
  'store-auditor': ['sources'],
  'seo-auditor': ['sources'],
  'evidence-curator': ['sources', 'concepts'],
  'page-writer': ['writing'],
  'ai-answer-optimizer': ['sources', 'concepts'],
  'product-page-optimizer': ['writing'],
  'storefront-tester': ['sources'],
  'blog-writer': ['writing'],
  'catalog-keeper': ['projects'],
  'promo-planner': ['projects'],
  'amazon-listing-auditor': ['sources'],
  'store-reporter': ['projects'],
  // Customer Care (dept-comms)
  'support-triage': ['inbox'],
  'reply-drafter': ['inbox', 'writing'],
  'dm-responder': ['inbox'],
  'refund-handler': ['inbox'],
  'shipping-tracker': ['inbox'],
  'faq-keeper': ['concepts'],
  'escalation-manager': ['inbox'],
  'review-monitor': ['sources'],
  'voice-of-customer': ['people', 'inbox'],
  'team-feed': ['org'],
  'care-reporter': ['projects'],
  // Finance (dept-finance)
  'payments-pulse': ['companies'],
  'ad-spend-ledger': ['projects'],
  'contribution-margin': ['projects'],
  'month-close': ['projects'],
  // Operations (dept-tech)
  'conductor': ['*'],
  'knowledge-agent': ['concepts', 'sources'],
  'brand-pack-keeper': ['media'],
  'brain-auditor': ['*'],
  'connector-monitor': ['org'],
  'scheduler': ['org'],
  'data-agent': ['*'],
};
