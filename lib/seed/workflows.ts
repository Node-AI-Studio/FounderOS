...
export const skills: Omit<Skill, 'markdown'>[] = [
  ...
  { id: 'skill-publish', name: 'Cadence publishing', category: 'Content', description: 'Daily posts across two platforms, never dark.', ownerAgentId: 'publisher', status: 'live', tools: ['zernio'], order: 6 },
