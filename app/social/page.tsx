...
export default async function SocialPage() {
  ...
  // behind Late's paid analytics add-on, so live posts show the post link in
  // its place, never invented numbers. An empty history renders as empty.
    ...
    <div>
      ...
      <section className="mb-6">
        <SectionHead
          label="Recent posts"
          count={
            recentLive ? `${livePosts.length} live · zernio` : 'none yet'
          }
        />
            ...
            : (
                <div className="sm:col-span-2 xl:col-span-5">
                  <EmptyState
                    ...
                    detail="Zernio has no published history for these accounts yet."
                    next="Posts queued below are published by the Social agent and appear here from Zernio."
                  />
                </div>
              )}
        </div>
